...
(let ((jake-pink "#fc199a")
  ...
  `(font-lock-bracket-face ((t (:inherit font-lock-punctuation-face :foreground nil))))
  `(font-lock-builtin-face ((t (:foreground ,jake-yellow))))
  `(font-lock-comment-delimiter-face ((default (:inherit font-lock-comment-face))))
  `(font-lock-comment-face ((t (:inherit jake-purple-subtle-glow :slant italic :foreground nil :background unspecified))))
  ...
  `(font-lock-function-name-face ((t (:inherit jake-yellow-glow :foreground nil :weight bold :slant italic))))
  `(font-lock-keyword-face ((t (:inherit jake-pink-glow :foreground nil :weight bold :slant normal))))
  ...
  `(font-lock-string-face ((t (:inherit jake-green-glow :foreground nil))))
  `(font-lock-type-face ((t (:inherit jake-yellow-glow :foreground nil))))
  ...
  `(mode-line ((t (:box (:line-width (1 . 1) :color ,jake-purple :style nil) :overline ,jake-purple :foreground ,jake-yellow :background ,jake-purple-dark))))
  ...
  `(mode-line-inactive ((t (:weight light :box (:line-width (1 . 1) :color ,jake-purple-subtle :style nil) :foreground ,jake-purple-subtle :background ,jake-dark))))
  ...
  `(rainbow-delimiters-depth-1-face ((t (:inherit jake-pink-glow :foreground nil :weight semibold))))
  `(rainbow-delimiters-depth-2-face ((t (:inherit jake-yellow-glow :foreground nil :weight semibold))))
  `(rainbow-delimiters-depth-3-face ((t (:inherit jake-green-glow :foreground nil :weight semibold))))
  `(rainbow-delimiters-depth-4-face ((t (:inherit jake-cyan-glow :foreground nil :weight semibold))))
  `(rainbow-delimiters-depth-5-face ((t (:inherit jake-purple-glow :foreground nil :weight semibold))))
  `(rainbow-delimiters-depth-6-face ((t (:inherit rainbow-delimiters-depth-1-face :foreground nil))))
  `(rainbow-delimiters-depth-7-face ((t (:inherit rainbow-delimiters-depth-2-face :foreground nil))))
  `(rainbow-delimiters-depth-8-face ((t (:inherit rainbow-delimiters-depth-3-face :foreground nil))))
  `(rainbow-delimiters-depth-9-face ((t (:inherit rainbow-delimiters-depth-4-face :foreground nil))))
