...
(let ((jake-pink "#fc199a")
  ...
  (custom-theme-set-faces
   ...
   `(rainbow-delimiters-depth-3-face ((t (:inherit (jake-green-glow) :foreground unspecified))))
   `(rainbow-delimiters-depth-4-face ((t (:inherit (jake-cyan-glow) :foreground unspecified))))
   `(rainbow-delimiters-depth-5-face ((t (:inherit (jake-purple-glow) :foreground unspecified))))
