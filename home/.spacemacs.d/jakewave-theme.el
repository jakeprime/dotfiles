...
(let ((jake-fixed "MonaspiceAr NFM")
  ...
  (custom-theme-set-faces
   ...
   `(org-block ((t (:inherit (fixed-pitch) :height 0.75 :background ,jake-purple-dark ))))
   `(org-block-begin-line ((t (:inherit (fixed-pitch jake-purple-subtle-glow) :height 0.75 :foreground unspecified :background ,jake-purple-dark))))
   `(org-block-end-line ((t (:inherit (fixed-pitch) :height 0.75 :foreground ,jake-purple-subtle :background ,jake-purple-dark))))
