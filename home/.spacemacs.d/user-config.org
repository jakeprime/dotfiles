...
*** Ruby
**** Bundler
Make sure we use bundler for flycheck and rubocop. Otherwise we would have issues when multiple projects use different versions, especially as the work ones are out of my individual control.
