  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(a ace-jump-helm-line ace-link aggressive-indent alert all-the-icons
         ...
         column-enforce-mode company company-go company-web counsel counsel-gtags
         dap-mode deferred define-word devdocs diminish dired-quick-sort
         dired-single diredfl disable-mouse doom-modeline dotenv-mode drag-stuff
         dumb-jump eat editorconfig elisp-def elisp-demos elisp-slime-nav emacsql
         ...
         fancy-battery feature-mode flx-ido flycheck-elsa flycheck-golangci-lint
         flycheck-package flycheck-pos-tip forge ggtags ghub git-link
         ...
         go-tag godoctor golden-ratio google-translate haml-mode helm-ag
         ...
         impatient-mode indent-guide inf-ruby inflections info+ inspector ivy
         js-doc js2-mode js2-refactor json-mode json-navigator json-reformat
         json-snatcher link-hint livid-mode log4e lorem-ipsum lsp-docker lsp-mode
         lsp-origami lsp-treemacs lsp-ui macrostep magit magit-delta magit-section
         markdown-mode minitest multi-line multi-term multi-vterm multiple-cursors
         nameless nerd-icons nodejs-repl npm-mode open-junk-file org
         ...
         org-rich-yank org-superstar orgit orgit-forge origami overseer paradox
         password-generator pcre2el popwin pos-tip prettier-js projectile-rails
         pug-mode quickrun rainbow-delimiters rake rbenv request restart-emacs
         ...
         seeing-is-believing shell-pop shrink-path simple-httpd skewer-mode
         ...
         swiper symbol-overlay symon tagedit term-cursor terminal-here tide
