...
(let ((jake-fixed "MonaspiceNe NFM")
      ...
      (jake-font-height (cond (jake/is-mac 130) (jake/is-linux 110) (t 120)))
  ...
  (defface jake-doc-heading `((t (:family ,jake-variable-heading :weight light))) "jakewave document heading")
  ...
  (custom-theme-set-faces
   ...
   `(diredfl-date-time ((t (:inherit jake-purple-glow :foreground unspecified))))
   ...
   `(diredfl-dir-heading ((t (:inherit jake-pink-glow :foreground unspecified))))
   `(diredfl-dir-name ((t (:inherit jake-pink-glow :foreground unspecified))))
   `(diredfl-dir-priv ((t (:inherit jake-yellow-glow :foreground unspecified))))
   `(diredfl-exec-priv ((t (:inherit jake-purple-glow :foreground unspecified))))
   ...
   `(diredfl-ignored-file-name ((t (:inherit jake-purple-subtle-glow :foreground unspecified))))
   `(diredfl-link-priv ((t (:inherit jake-yellow-glow :foreground unspecified))))
   `(diredfl-no-priv ((t (:inherit jake-purple-subtle-glow :foreground unspecified))))
   ...
   `(diredfl-symlink ((t (:inherit jake-purple-glow :foreground unspecified))))
   `(diredfl-write-priv ((t (:inherit jake-pink-glow :foreground unspecified))))
   ...
   `(highlight-numbers-number ((t :inherit jake-pink-glow)))
   ...
   `(jake-sorbet-sig ((t (:foreground ,jake-purple-subtle))))
   ...
   `(magit-blame-date (( t (:background unspecified :foreground ,jake-purple-subtle))))
   `(magit-blame-heading (( t (:background ,jake-darkest :overline ,jake-purple-subtle :foreground ,jake-purple-subtle))))
   `(magit-blame-name (( t (:background unspecified :foreground ,jake-purple-subtle))))
   `(magit-blame-summary (( t (:background unspecified :foreground ,jake-purple-subtle))))
   ...
   `(markdown-list-face ((t :inherit jake-purple-glow :background unspecified)))
   `(markdown-markup-face ((t :inherit org-block :background)))
   `(markdown-table-face (( t :inherit org-table :background unspecified :foreground unspecified)))
   ...
   `(org-block ((t (:inherit (fixed-pitch) :background ,jake-purple-dark :height 0.75 ))))
   `(org-block-begin-line ((t (:inherit (fixed-pitch jake-purple-subtle-glow) :foreground unspecified :background ,jake-purple-dark :height 0.75))))
   `(org-block-end-line ((t (:inherit (fixed-pitch) :foreground ,jake-purple-subtle :background ,jake-purple-dark :height 0.75))))
   ...
   `(org-code ((t (:inherit (fixed-pitch) :background ,jake-purple-dark :foreground ,jake-pink :height 0.75))))
   ...
   `(org-level-1 ((t (:inherit (jake-doc-heading jake-pink-glow) :foreground unspecified :height 2.0 :weight unspecified))))
   `(org-level-2 ((t (:inherit jake-doc-heading :foreground ,jake-org-2 :height 1.5))))
   `(org-level-3 ((t (:inherit jake-doc-heading :foreground ,jake-org-3 :height 1.25))))
   `(org-level-4 ((t (:inherit jake-doc-heading :foreground ,jake-org-4 :height 1.1))))
   `(org-level-5 ((t (:inherit jake-doc-heading :foreground ,jake-org-5 :height 1.0))))
   `(org-level-6 ((t (:inherit jake-doc-heading :foreground ,jake-org-6 :height 1.0))))
   `(org-level-7 ((t (:inherit jake-doc-heading :foreground ,jake-org-7 :height 1.0))))
   `(org-level-8 ((t (:inherit jake-doc-heading :foreground ,jake-org-8 :height 1.0))))
   `(org-link ((t (:inherit (jake-cyan-highlight-glow) :foreground unspecified :underline unspecified))))
   `(org-meta-line ((t (:inherit (fixed-pitch) :foreground ,jake-purple-subtle :background unspecified :height 0.75))))
   ...
   `(org-table ((t (:inherit (fixed-pitch) :foreground ,jake-green :background ,jake-purple-dark :height 0.75 :extend t))))
   ...
   `(org-verbatim ((t (:inherit (fixed-pitch jake-yellow-glow) :foreground unspecified :background ,jake-purple-dark :weight ,jake-normal-weight :height 0.75))))
   ...
   `(smerge-base ((t (:background ,jake-purple-dark))))
   `(smerge-lower ((t (:background ,jake-purple-dark))))
   `(smerge-markers ((t (:inherit font-lock-comment-face :background ,jake-dark :foreground unspecified :weight normal :slant normal))))
   ...
   `(smerge-refined-removed ((t (:inherit jake-pink-glow :background unspecified :foreground unspecified))))
   `(smerge-upper ((t (:background ,jake-purple-dark))))
