...
See the header of this file for more information."
  ...
  (load-file "~/.config/spacemacs/user-env.el")
  )
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(safe-local-variable-values
     '((lsp-sorbet-use-bundler . t) (lsp-sorbet-as-add-on . t) (typescript-backend . tide)
       (typescript-backend . lsp) (javascript-backend . tide) (javascript-backend . tern)
       (javascript-backend . lsp) (ruby-test-rails-test-command . "bin/spring rails test")
